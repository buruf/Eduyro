...
## Systemic notes (not fixed in this pass)
...
#### M2:Compare two-digit numbers → M3:Adding by counting on (+1, +2, +3)
- **broken** · **fixed** — engine: missing-number form removed from every lesson before Fact families; opening sheet of every unit is the direct form
...
- **lesson-mismatch** · **fixed** — engine: missing-number form removed from every lesson before Fact families; opening sheet of every unit is the direct form
...
- **lesson-mismatch** · **fixed** — lesson rewritten with a column method on 542 − 372; across-zero subtractions banded to later sheets
...
- **lesson-mismatch** · **fixed** — lesson lookup was matching the M5 multiplication 'Mixed review' — now scoped to the level's operation (gate 2)
