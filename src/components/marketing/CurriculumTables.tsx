...
const CURRICULUM: Record<SubjectKey, {
  ...
  math: {
    ...
    levels: [
      { code: "M1",  name: "Early Counting",        grade: "Pre-K",          skills: 7, sheetsPerSkill: "30+" },
      { code: "M2",  name: "Number Sense",           grade: "Pre-K – K",      skills: 8, sheetsPerSkill: "30+" },
      { code: "M3",  name: "Addition",               grade: "K – Grade 1",    skills: 10, sheetsPerSkill: "30+" },
      { code: "M4",  name: "Subtraction",            grade: "Grade 1 – 2",    skills: 10, sheetsPerSkill: "30+" },
      { code: "M5",  name: "Multiplication Fluency", grade: "Grade 2 – 4",    skills: 10, sheetsPerSkill: "30+" },
      { code: "M6",  name: "Division Foundations",   grade: "Grade 3 – 5",    skills: 10, sheetsPerSkill: "30+" },
      { code: "M7",  name: "Fractions",              grade: "Grade 4 – 6",    skills: 31, sheetsPerSkill: "10+" },
      { code: "M8",  name: "Decimals & Percentages", grade: "Grade 5 – 6",    skills: 10, sheetsPerSkill: "30+" },
      { code: "M9",  name: "Ratios & Proportions",   grade: "Grade 6 – 7",    skills: 5, sheetsPerSkill: "30+" },
      { code: "M10", name: "Pre-Algebra",            grade: "Grade 7 – 8",    skills: 12, sheetsPerSkill: "30+" },
      { code: "M11", name: "Linear Equations",       grade: "Grade 8 – 9",    skills: 9, sheetsPerSkill: "30+" },
      { code: "M12", name: "Polynomials",            grade: "Grade 9 – 10",   skills: 24, sheetsPerSkill: "10+" },
      { code: "M13", name: "Quadratics",             grade: "Grade 9 – 10",   skills: 8, sheetsPerSkill: "30+" },
      { code: "M14", name: "Functions",              grade: "Grade 10 – 11",  skills: 6, sheetsPerSkill: "30+" },
      { code: "M15", name: "Trigonometry",           grade: "Grade 11 – 12",  skills: 5, sheetsPerSkill: "30+" },
      { code: "M16", name: "Algebra II",             grade: "Grade 11 – 12",  skills: 13, sheetsPerSkill: "20+" },
      { code: "M17", name: "Pre-Calculus",           grade: "Grade 12",       skills: 7, sheetsPerSkill: "30+" },
      { code: "M18", name: "Calculus",               grade: "Grade 12",       skills: 6, sheetsPerSkill: "30+" },
    ],
  },
  reading: {
    name: "Reading",
    ...
    levels: [
      { code: "R1", name: "Letter Recognition",      grade: "Pre-K",         skills: 2, sheetsPerSkill: "30+" },
      { code: "R2", name: "Long Vowels & Phonics",   grade: "Grade 1 – 2",   skills: 5, sheetsPerSkill: "20+" },
