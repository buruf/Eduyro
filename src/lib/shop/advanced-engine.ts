...
const CURRICULA: Record<string, Unit[]> = {
  ...
  POLYNOMIALS: [
    ...
    { id:"poly-factor-aN", label:"Factor trinomials (a ≠ 1)", objective:"Student factors ax² + bx + c with a leading coefficient", directive:"Factor each trinomial into two binomials.", grade:"Grade 9-10", stars:5, range:[79,83], pool:()=>enumFactorTrinomialA(), example:{ problem:"Factor 2x² + 7x + 3", steps:["First terms must multiply to 2x²: (2x    )(x    )","Last terms must multiply to 3: 1 and 3","Try (2x + 1)(x + 3): outer 2x·3 = 6x, inner 1·x = x, 6x + x = 7x ✓ (if it fails, swap: (2x + 3)(x + 1) gives 2x + 3x = 5x ✗)","(2x + 1)(x + 3)"], answer:"(2x + 1)(x + 3)" } },
