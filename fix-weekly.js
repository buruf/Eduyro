const fs = require('fs');
const f = 'src/lib/cron/jobs/weekly-progress.ts';

const content = `// src/lib/cron/jobs/weekly-progress.ts
...
console.log('weekly-progress.ts written');

// Verify no bad field references
const c = fs.readFileSync(f, 'utf8');
console.log('awardedAt:', c.includes('awardedAt'));       // should be false
console.log('parentLinks:', c.includes('parentLinks'));    // should be false
console.log('earnedAt:', c.includes('earnedAt'));          // should be true
console.log('parent.children:', c.includes('parent: {'));  // should be true
console.log('dailyAccuracy on progress:', c.includes('progress?.dailyAccuracy')); // should be true
console.log('All should be: false, false, true, true, true');
